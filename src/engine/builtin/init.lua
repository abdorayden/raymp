...
--
-- Configuration files populate the global frame config directly (raymp.engine)
...
settings.theme =
"default"                         -- default theme [default , darkandwhite , desert , elflord] , nil to disable theme
...
local soundMap = raymp.engine.soundMap
